...
class ComposerAutoloaderInit800730d4b04101d2d87884a83e898900
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit800730d4b04101d2d87884a83e898900::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire800730d4b04101d2d87884a83e898900($fileIdentifier, $file);
        }
...
function composerRequire800730d4b04101d2d87884a83e898900($fileIdentifier, $file)
{
